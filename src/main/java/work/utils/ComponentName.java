...
public class ComponentName {
    public static final String codeDebts = "codeDebts";
    public static final String techIssues = "techIssues";
    public static final String backEndCoverages = "backEndCoverages";
